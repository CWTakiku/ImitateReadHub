...
public class BarUtil {
    ...
    public static int getStatusBarHeight() {
        Resources resources = MyApplication.getmInstance().getAppContext().getResources();
    ...
    public static int getActionBarHeight() {
        ...
        if (MyApplication.getmInstance().getAppContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, MyApplication.getmInstance().getAppContext().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = MyApplication.getmInstance().getAppContext().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = MyApplication.getmInstance().getAppContext().getResources();
